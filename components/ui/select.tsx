...
>(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn("py-1.5 pl-8 rtl:pr-8 pr-2 rtl:pl-2 text-sm font-semibold", className)}
 {...props}
 />
));
...
>(
 ...
 {...props}
 >
 <span className="absolute right-2 rtl:left-2 flex h-3.5 w-3.5 items-center justify-center">
